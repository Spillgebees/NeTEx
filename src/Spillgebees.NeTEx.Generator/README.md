...
Downloads schemas from the official [NeTEx-CEN/NeTEx](https://github.com/NeTEx-CEN/NeTEx) repository and generates modern C# code ready to use with `XmlSerializer`.
